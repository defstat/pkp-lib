...
/**
 * @file controllers/grid/files/submissionDocuments/form/EditSubmissionLibraryFileForm.inc.php
 *
 * Copyright (c) 2014-2020 Simon Fraser University
 * Copyright (c) 2003-2020 John Willinsky
 * Distributed under the GNU GPL v3. For full terms see the file docs/COPYING.
 *
 * @class EditSubmissionLibraryFileForm
...
class EditSubmissionLibraryFileForm extends LibraryFileForm {
